...
app.use(
  cors({
    origin: ["http://edc-steal-share.s3-website.ap-south-1.amazonaws.com", "ws://edc-steal-share.s3-website.ap-south-1.amazonaws.com", "http://localhost:5173", "ws://localhost:5173"], // Allow requests from any origin
